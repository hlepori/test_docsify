...
Interpretation
The operative verb “shall” is used for formal requirements. The operative verb “should” is used for recommendations. Formal requirements are mandatory and must be satisfied by FIXM. Recommendations are not mandatory; however, compliance is strongly advised, and non-compliance must be justified.
